...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__37800 = c;
var G__37800__$1 = (((G__37800 == null))?null:G__37800.prototype);
if((G__37800__$1 == null)){
return null;
} else {
return G__37800__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__37804 = c;
var G__37804__$1 = (((G__37804 == null))?null:G__37804.prototype);
if((G__37804__$1 == null)){
return null;
} else {
return G__37804__$1.render;
}
})() == null)))));
});
...
var _STAR_current_component_STAR__orig_val__37817 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__37818 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__37818);

try{return reagent.impl.component.wrap_render(c,compiler);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__37817);
}});
...
var c = this;
var G__37845_37909 = reagent.impl.component.goog$module$goog$object.get(c,"cljsRatom");
if((G__37845_37909 == null)){
} else {
reagent.ratom.dispose_BANG_(G__37845_37909);
}
...
var renders_37910 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_37911 = cljs.core.first(cljs.core.vals(renders_37910));
...
if((cljs.core.count(renders_37910) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_37910))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_37911)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_37911], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
