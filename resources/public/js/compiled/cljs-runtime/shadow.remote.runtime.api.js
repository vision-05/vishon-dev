...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_32511 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_32511(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_32512 = (function (runtime,key,spec){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_32512(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_32513 = (function (runtime,key){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_32513(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_32515 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_32515(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_32521 = (function (runtime,input,callback){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_32521(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_32522 = (function (runtime,code){
var x__4550__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_32522(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__32505,callback){
var map__32507 = p__32505;
var map__32507__$1 = cljs.core.__destructure_map(map__32507);
var input = map__32507__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32507__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32507__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
