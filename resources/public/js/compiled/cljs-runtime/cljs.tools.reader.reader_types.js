...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_30475 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_30475(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_30477 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_30477(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_30478 = (function (reader,ch){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_30478(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_30480 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_30480(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_30481 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_30481(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_30482 = (function (reader){
var x__4550__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_30482(reader);
}
});
...
var G__30497 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__30498 = s.append(c);
c = G__30497;
s = G__30498;
continue;
}
