...
var len__4864__auto___28171 = arguments.length;
var i__4865__auto___28172 = (0);
while(true){
if((i__4865__auto___28172 < len__4864__auto___28171)){
args__4870__auto__.push((arguments[i__4865__auto___28172]));

var G__28173 = (i__4865__auto___28172 + (1));
i__4865__auto___28172 = G__28173;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq28056){
...
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__28057,G__28058,seq28056__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__28087_SHARP_){
return (!((cljs.core.meta(p1__28087_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28128__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e28129){var _e__26909__auto__ = e28129;
return false;
}})();
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
...
}catch (e28136){var _e__26909__auto__ = e28136;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__28145 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__28147 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__28147);

try{var map__28149 = opts;
var map__28149__$1 = cljs.core.__destructure_map(map__28149);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28149__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__28145);
}});
...
var temp__5751__auto___28201 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5751__auto___28201)){
var managed_print_level_28202 = temp__5751__auto___28201;
var _STAR_print_level_STAR__orig_val__28154_28203 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__28155_28204 = managed_print_level_28202;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__28155_28204);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__28151_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__28151_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__28154_28203);
}} else {
job_fn();
}
