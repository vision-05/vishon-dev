...
var i_32351 = (0);
while(true){
if((i_32351 < arr.length)){
(arr[i_32351] = null);

var G__32352 = (i_32351 + (1));
i_32351 = G__32352;
continue;
} else {
}
...
var i_32363 = (self__.level + (1));
while(true){
if((i_32363 <= (new_level + (1)))){
(update[i_32363] = self__.header);
...
while(true){
if((i <= self__.level)){
var links_32365 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_32365[i]));
} else {
x__$2.forward.push((((i < links_32365.length))?(links_32365[i]):null));
}

if((i < links_32365.length)){
(links_32365[i] = x__$2);
} else {
links_32365.push(x__$2);
}
...
var i_32367 = (0);
while(true){
if((i_32367 <= self__.level)){
var links_32368 = (update[i_32367]).forward;
if((x__$1 === (((i_32367 < links_32368.length))?(links_32368[i_32367]):null))){
(links_32368[i_32367] = (x__$1.forward[i_32367]));

var G__32371 = (i_32367 + (1));
i_32367 = G__32371;
continue;
} else {
var G__32372 = (i_32367 + (1));
i_32367 = G__32372;
continue;
}
} else {
