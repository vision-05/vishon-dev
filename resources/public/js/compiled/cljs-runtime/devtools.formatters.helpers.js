...
var G__28049 = devtools.prefs.pref(v);
v = G__28049;
continue;
} else {
return v;
...
}catch (e27974){var _e__26909__auto__ = e27974;
return false;
}})();
...
}catch (e27977){var _e__26909__auto__ = e27977;
return false;
}})();
...
}catch (e27981){var _e__26909__auto__ = e27981;
return false;
}}
}
});
...
var vec__28016 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28016,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28016,(1),null);
...
return cljs.core.some((function (p1__28024_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__28024_SHARP_);
}),template);
});
